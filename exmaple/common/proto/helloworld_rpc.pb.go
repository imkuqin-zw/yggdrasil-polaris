...
func (c *greeterClient) SayHello(ctx context.Context, in *HelloRequest) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/yggdrasil.polaris.example.common.proto.Greeter/SayHello", in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greeterClient) SayHelloStream(ctx context.Context) (GreeterSayHelloStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreeterServiceDesc.Streams[0], "/yggdrasil.polaris.example.common.proto.Greeter/SayHelloStream")
	if err != nil {
		return nil, err
	}
...
func (c *greeterClient) SayHelloClientStream(ctx context.Context) (GreeterSayHelloClientStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreeterServiceDesc.Streams[1], "/yggdrasil.polaris.example.common.proto.Greeter/SayHelloClientStream")
	if err != nil {
		return nil, err
	}
...
func (c *greeterClient) SayHelloServerStream(ctx context.Context, in *HelloRequest) (GreeterSayHelloServerStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreeterServiceDesc.Streams[2], "/yggdrasil.polaris.example.common.proto.Greeter/SayHelloServerStream")
	if err != nil {
		return nil, err
	}
...
func _Greeter_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, unaryInt interceptor.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &interceptor.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/yggdrasil.polaris.example.common.proto.Greeter/SayHello",
	}
...
var GreeterServiceDesc = server.ServiceDesc{
	ServiceName: "yggdrasil.polaris.example.common.proto.Greeter",
